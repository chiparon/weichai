...
function validateRevisionScopedModulePlan(
  ...
  assertOnlyKeys(value, [
    "schemaVersion", "repositoryId", "analysisRevision", "analysisHash", "objective", "modules", "dependencies", "risks",
  ], "RevisionScopedModulePlanProposal");
  if (value.schemaVersion !== moduleMigrationSchemaVersion) {
  ...
  if (value.modules.length === 0) throw new Error("RevisionScopedModulePlanProposal.modules must not be empty.");
